...
모델 (2025-2026):
  TIER1: gemini-2.5-pro    ($1.25/$10.00 per 1M) — 1M 컨텍스트, Extended Thinking
  TIER2: gemini-2.5-flash  ($0.15/$0.60  per 1M) — 1M 컨텍스트 경량화
  TIER3: gemini-2.0-flash  ($0.10/$0.40  per 1M) — 최경량
...
_DEFAULT_TIER1 = 'gemini-2.5-pro'
_DEFAULT_TIER2 = 'gemini-2.5-flash'
_DEFAULT_TIER3 = 'gemini-2.0-flash'
...
class GoogleProvider(AIProvider):
    ...
    def estimate_cost(self, tokens_in: int, tokens_out: int,
        ...
        ip, op = _PRICE_FALLBACK.get(model, (1.25, 10.00))
