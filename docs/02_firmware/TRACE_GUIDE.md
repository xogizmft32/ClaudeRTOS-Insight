# ClaudeRTOS 트레이스 가이드 V2
# ClaudeRTOS Trace Guide V2

> Configure what data the firmware collects and transmits. Three built-in profiles (LITE / STANDARD / EXPERT) cover most use cases.
...
*Quick Start — Add 3 Lines to FreeRTOSConfig.h*
...
*Trace Modes — Select in trace_config.h*
...
*Lock-Free Ring Buffer — No Critical Sections Required*
...
*DWT CYCCNT Timestamps — Hardware Counter, No Division*
...
*DWT EXCCNT ISR Frequency — Zero Overhead via Hardware Counter*
...
## 수집 이벤트
*Collected Events — What Gets Traced*
...
## 호스트 JSON 컨텍스트
*Host JSON Context — Data Structure Sent to the Analysis Engine*
