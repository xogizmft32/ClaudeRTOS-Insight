...
All functions in ClaudeRTOS-Insight V4.2.0 have **estimated Worst-Case Execution Times (WCET)** derived through:
...
ClaudeRTOS-Insight V4.2.0 provides **estimated WCET** for all functions:
