# Quick Troubleshooting — ClaudeRTOS-Insight V3.9.1
...
**해결:** V3.9.1의 `event_classifier.c`를 `claudertos/` 폴더에 복사하거나 `python3 install.py --project .` 재실행.
...
2. 보드 리셋 후 "ClaudeRTOS-Insight V3.9.1.0 Started [ITM]" 확인
